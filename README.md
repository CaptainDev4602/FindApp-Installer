...
the app installation if you want to install FindApp Installer you must download the zip extract it and then run the executable in the terminal
and enjoy.
this tool is licensed under the gnu gplv3 this means you can contribute on this project to become bigger and bigger but always the code
